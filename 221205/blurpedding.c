...
int main(int argc, char** argv) 
{
    ...
    RGBQUAD *palrgb;
    ubyte *inimg, *outimg, *padding, *padding_inimg;
    int x, y, z, imageSize;
    ...
    printf("Padding_inimg : %d\n",imageSize+padding_size);
    
    inimg = (ubyte*)malloc(sizeof(ubyte)*imageSize+padding_size); 
    outimg = (ubyte*)malloc(sizeof(ubyte)*imageSize+padding_size);
    //padding = (ubyte*)malloc(sizeof(ubyte)*padding_size);
    padding_inimg = (ubyte*)malloc(sizeof(ubyte)*(imageSize+padding_size));
...
*/
    ...
    memset(outimg, 0, sizeof(ubyte)*imageSize+padding_size);
